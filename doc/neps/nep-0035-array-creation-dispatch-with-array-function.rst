...
.. [1] :ref:`NEP 18 - A dispatch mechanism for NumPy's high level array functions`.

.. [2] `PEP 3102 — Keyword-Only Arguments <https://www.python.org/dev/peps/pep-3102/>`_.

.. [3] :ref:`NEP 30 — Duck Typing for NumPy Arrays - Implementation`.

.. [4] :ref:`NEP 31 — Context-local and global overrides of the NumPy API`.

.. [5] `Array creation routines <https://docs.scipy.org/doc/numpy-1.17.0/reference/routines.array-creation.html>`_.

.. [6] :ref:`NEP 37 — A dispatch protocol for NumPy-like modules`.
